...
CROSS_DOC_SIGNALS = [
    "compare", "comparison", "changed", "evolved", "trend",
    "over the years", "year over year", "yoy", "across",
    "difference between", "how has", "how have",
    "growth", "decline", "increase", "decrease",
    "historical", "multi-year", "three year", "five year",
]

# Keywords that signal quantitative focus
QUANT_SIGNALS = [
    "ratio", "pe", "p/e", "debt", "revenue", "income",
    "margin", "ebitda", "cash flow", "fcf", "roi", "roe",
    "eps", "earnings per share", "valuation", "price",
    "market cap", "dividend", "yield", "turnover",
    "benchmark", "sector", "industry average",
]

# Keywords that signal risk focus
RISK_SIGNALS = [
    "risk", "fraud", "concern", "weakness", "audit",
    "litigation", "lawsuit", "regulatory", "compliance",
    "governance", "related party", "impairment",
    "going concern", "material weakness", "restatement",
    "investigation", "enforcement", "violation",
]
